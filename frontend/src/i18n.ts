...
const core: LocaleDicts = {
  en: {
    ...
    "ws.units": "Units",
    "ws.stmt.balanceSheet": "Balance sheet",
    "ws.stmt.profitLoss": "Profit & loss",
    "ws.stmt.cashFlow": "Cash flow",
    "ws.units.asReported": "As reported",
  ...
  zh: {
    ...
    "ws.currency": "币种",
    "ws.units": "单位",
    "ws.stmt.balanceSheet": "资产负债表",
    "ws.stmt.profitLoss": "利润表",
    "ws.stmt.cashFlow": "现金流量表",
    "ws.units.asReported": "按原始报告",
  ...
  ar: {
    ...
    "ws.currency": "العملة",
    "ws.units": "الوحدات",
    "ws.stmt.balanceSheet": "الميزانية العمومية",
    "ws.stmt.profitLoss": "الأرباح والخسائر",
    "ws.stmt.cashFlow": "التدفقات النقدية",
    "ws.units.asReported": "كما وردت",
  ...
  fr: {
    ...
    "ws.currency": "Devise",
    "ws.units": "Unités",
    "ws.stmt.balanceSheet": "Bilan",
    "ws.stmt.profitLoss": "Compte de résultat",
    "ws.stmt.cashFlow": "Flux de trésorerie",
    "ws.units.asReported": "Tel que déclaré",
